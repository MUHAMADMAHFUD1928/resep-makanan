...
class Judul_Resep2 extends StatefulWidget {
  static const String routes = 'Judul_Resep';
  const Judul_Resep2({Key? key}) : super(key: key);

  @override
  State<Judul_Resep2> createState() => _Judul_Resep2State();
}

class _Judul_Resep2State extends State<Judul_Resep2> {
